...
effr = read.csv("C:/Users/msses/Desktop/TCC/dados/EFFR/EFFR.csv")

effr$Date <- as.Date(effr$DATE)
effr = effr %>%  
  rename(date = Date) %>% 
  dplyr::mutate(EFFR = as.numeric(EFFR)/100) %>% 
  select(date,EFFR)
...
save(hf_complete, file = "C:/Users/msses/Desktop/TCC/dados/HF/hf_complete_effr.RData")
...
save(etf_complete, file = "C:/Users/msses/Desktop/TCC/dados/ETF/etf_complete_effr.RData")
